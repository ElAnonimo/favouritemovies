// Updates existing movie-goer detail
$(document).ready(function(){
	...
	$(document).on('focus', '.data', function() {
		...
		$id = $id[1];
		$thisName = $this.val(); // former firstname
		...
		$otherName = $('tr#user_' + $id + ' .data[name="' + $otherField + '"]').val(); // former lastname
